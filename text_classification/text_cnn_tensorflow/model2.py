...
from text_cnn_tensorflow import text_cnn
...
class Model:
    ...
    def _build_loss(self, output):
        self.loss = tf.losses.softmax_cross_entropy(self.targets, output, scope="loss")
    ...
    def _build_optimizer(self):
        self.train_op = tf.layers.optimize_loss(
            ...
            optimizer='Adam',
            learning_rate=Config.train.learning_rate,  # todo 学习率还可以衰减，梯度也可以优化
